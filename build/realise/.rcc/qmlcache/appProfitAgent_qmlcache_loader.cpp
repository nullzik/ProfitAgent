...
namespace _qt_qml_ProfitAgent_presentation_views_dialogs_ActivityDetailsDialog_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_ProfitAgent_presentation_views_dialogs_EditEmployeeDialog_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_ProfitAgent_presentation_views_dialogs_FinanceTransactionDialog_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/ProfitAgent/presentation/views/dialogs/ActivityDetailsDialog.qml"), &QmlCacheGeneratedCode::_qt_qml_ProfitAgent_presentation_views_dialogs_ActivityDetailsDialog_qml::unit);
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/ProfitAgent/presentation/views/dialogs/EditEmployeeDialog.qml"), &QmlCacheGeneratedCode::_qt_qml_ProfitAgent_presentation_views_dialogs_EditEmployeeDialog_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/ProfitAgent/presentation/views/dialogs/FinanceTransactionDialog.qml"), &QmlCacheGeneratedCode::_qt_qml_ProfitAgent_presentation_views_dialogs_FinanceTransactionDialog_qml::unit);
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appProfitAgent)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appProfitAgent))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appProfitAgent)() {
    return 1;
}
